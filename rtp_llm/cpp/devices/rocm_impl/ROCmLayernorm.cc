        ...
        if (params.norm_type == NormType::layernorm) {
            ...
            switch (data_type) {
                case DataType::TYPE_FP32: {
                    invokeGeneralRmsNorm<float, void>(
                        reinterpret_cast<float*>(norm_output->data()),     // out
                        reinterpret_cast<const float*>(input->data()),     // input
                        reinterpret_cast<const float*>(gamma),             // gamma
                ...
                case DataType::TYPE_FP16: {
                    invokeGeneralRmsNorm<half, void>(
                        reinterpret_cast<half*>(norm_output->data()),      // out
                        reinterpret_cast<const half*>(input->data()),      // input
                        reinterpret_cast<const half*>(gamma),              // gamma
                        nullptr,                                           // beta (RMSNorm不需要beta)
                        static_cast<float>(eps),                           // eps
                        static_cast<int>(m),                               // tokens
                        static_cast<int>(n),                               // hidden_dim
                ...
                case DataType::TYPE_BF16: {
                    invokeGeneralRmsNorm<__nv_bfloat16, void>(
                        reinterpret_cast<__nv_bfloat16*>(norm_output->data()),      // out
                        reinterpret_cast<const __nv_bfloat16*>(input->data()),      // input
                        reinterpret_cast<const __nv_bfloat16*>(gamma),              // gamma
                        nullptr,                                                    // beta (RMSNorm不需要beta)
                        static_cast<float>(eps),                                    // eps
                        static_cast<int>(m),                                        // tokens
                        static_cast<int>(n),                                        // hidden_dim
