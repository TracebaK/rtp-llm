...
def git_deps():
    ...
    http_archive(
        name = "six_archive",
        build_file = clean_dep("@rtp_llm//3rdparty/six:six.BUILD"),
    ...
    new_git_repository(
        ...
        build_file = clean_dep("@rtp_llm//3rdparty/rapidjson:rapidjson.BUILD"),
    )
    ...
    http_archive(
        name = "curl",
        build_file = clean_dep("@rtp_llm//3rdparty/curl:curl.BUILD"),
